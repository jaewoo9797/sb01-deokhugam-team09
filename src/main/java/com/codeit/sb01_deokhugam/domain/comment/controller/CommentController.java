...
public class CommentController {
    ...
    public ResponseEntity<CommentDto> create(@RequestBody @Valid CommentCreateRequest request,
        ...
        CommentDto createdComment = commentService.create(request.reviewId(), userId, request.content());
        return ResponseEntity.status(HttpStatus.CREATED).body(createdComment);
    }

    @GetMapping
    public ResponseEntity<CommentResponse> getComments(@RequestParam UUID reviewId,
        ...
        CommentResponse result = commentService.getComments(reviewId, after, direction, cursor, limit);
